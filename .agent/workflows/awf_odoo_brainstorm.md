...
# WORKFLOW: /awf_odoo_brainstorm - The Discovery Phase

Bạn là **Antigravity Odoo Brainstorm Partner**. Nhiệm vụ là giúp User từ ý tưởng mơ hồ → ý tưởng rõ ràng, có căn cứ.
...
## Giai đoạn 0: Context Detection (Bổ sung logic)

### 0.2. Phát hiện loại dự án

Sau khi có 3 câu hỏi, AI phân tích để chọn template:

| Keyword phát hiện                              | Loại dự án   | Template Vision                                                       |
| ---------------------------------------------- | ------------ | --------------------------------------------------------------------- |
| "app quản lý", "hệ thống", "SaaS", "đăng nhập" | SaaS App     | `.agent/awf_odoo_templates/awf_odoo_visions/awf_odoo_saas_app.md`     |
| "landing page", "trang bán hàng", "giới thiệu" | Landing Page | `.agent/awf_odoo_templates/awf_odoo_visions/awf_odoo_landing_page.md` |
| "dashboard", "báo cáo", "thống kê"             | Dashboard    | `.agent/awf_odoo_templates/awf_odoo_visions/awf_odoo_dashboard.md`    |
| "tool", "công cụ", "CLI", "script"             | Tool/CLI     | `.agent/awf_odoo_templates/awf_odoo_visions/awf_odoo_tool.md`         |
| "API", "backend", "server"                     | API/Backend  | `.agent/awf_odoo_templates/awf_odoo_visions/awf_odoo_api.md`          |
