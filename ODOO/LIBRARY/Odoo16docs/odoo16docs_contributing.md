# ODOO DOCUMENTATION SUMMARY - CATEGORY: ODOO16DOCS_CONTRIBUTING
...
- For a view: `{<model_name>}_view_{<view_type>}`{.interpreted-text
  role="samp"}, where *view_type* is `kanban`, `form`, `tree`, `search`,
  \...
...
1.  Choose the version of Odoo to which you want to make changes. Keep
    ...
    `unsupported version of Odoo </administration/supported_versions>`{.interpreted-text
...
- `Use relative links for internal URLs. <contributing/rst/relative-links>`{.interpreted-text
  role="ref"}
- `Do not break hyperlink targets when refactoring. <contributing/rst/update-targets>`{.interpreted-text
  role="ref"}
- `Do not use non-descriptive hyperlink labels. <contributing/rst/descriptive-labels>`{.interpreted-text
  role="ref"}
...
## Hyperlinks {#contributing/rst/hyperlinks-guidelines}

### Internal URLs: relative links {#contributing/rst/relative-links}
...
### Refactoring: hyperlink targets {#contributing/rst/update-targets}
...
### Hyperlink labels {#contributing/rst/descriptive-labels}

Do not use non-descriptive labels for
`hyperlinks <contributing/rst/hyperlinks>`{.interpreted-text
role="ref"}.
...
symbols ([=]{.title-ref}) as there are characters in the header.
...
There are two icon sets used in Odoo:
[FontAwesome4](https://fontawesome.com/v4/icons/) and `Odoo UI
</developer/reference/user_interface/icons>`{.interpreted-text
role="doc"}. Follow the icon with its name as a
...
| `(area chart)`{.interpreted-text role="guilabel"} icon. The pivot view is represented by  |
| the `oi-view-pivot`{.interpreted-text role="icon"} icon.                                  |
+-------------------------------------------------------------------------------------------+
| ``` text                                                                                  |
...
role="ref"} when targeting another documentation page. - Do not use
`non-descriptive hyperlink labels <contributing/rst/descriptive-labels>`{.interpreted-text
role="ref"}.
::::
...
### External hyperlink aliases {#contributing/rst/external-hyperlink-aliases}
...
without any URL. They allow referencing a specific part of a RST file by
using the target as an anchor. When users click the reference, they are
...
Notice that there is no [\_]{.title-ref} at the end, contrary to what is
done with `external hyperlinks
<contributing/rst/external-hyperlinks>`{.interpreted-text role="ref"}.
::::

+-----------------------------------------------------------------------------------------+
| Please refer to the `contributing/rst/hyperlinks-guidelines`{.interpreted-text          |
| role="ref"} section to learn more about                                                 |
| `relative links <contributing/rst/relative-links>`{.interpreted-text role="ref"}.       |
+-----------------------------------------------------------------------------------------+
| ``` text                                                                                |
...
two ways to use the markup, both using the [doc]{.title-ref} markup:
...
### File download hyperlinks {#contributing/rst/download}
...
| **Metadata**                | **Purpose**                                                                      |
+-----------------------------+----------------------------------------------------------------------------------+
| [show-content]{.title-ref}  | > Make a toctree page accessible from the navigation menu.                       |
+-----------------------------+----------------------------------------------------------------------------------+
| [show-toc]{.title-ref}      | > Show the table of content on a page that has the [show-content]{.title-ref}    |
|                             | > metadata markup.                                                               |
+-----------------------------+----------------------------------------------------------------------------------+
...
+-----------------------------+----------------------------------------------------------------------------------+
| [orphan]{.title-ref}        | Suppress the need to include the document in a toctree.                          |
+-----------------------------+----------------------------------------------------------------------------------+
...
1.  Choose the version of the documentation to which you want to make
    ...
    </administration/supported_versions>`{.interpreted-text role="doc"}
    are not accepted. This guide assumes that the changes target the
    documentation of Odoo {CURRENT_VERSION}, which corresponds to branch
    [{CURRENT_BRANCH}]{.title-ref}.
